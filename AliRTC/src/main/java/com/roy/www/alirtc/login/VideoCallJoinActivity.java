package com.roy.www.alirtc.login;
...
import com.roy.www.alirtc.base.BaseActivity;
import com.roy.www.alirtc.bean.RTCAuthInfo;
import com.roy.www.alirtc.bean.RTCMeetingInfo;
import com.roy.www.alirtc.listener.ChannelTextWatchListener;
import com.roy.www.alirtc.listener.TextChangeListener;
import com.roy.www.alirtc.listener.TextWatcherListener;
import com.roy.www.alirtc.network.RequestRTCAuthInfo;
import com.roy.www.alirtc.utils.MockAliRtcAuthInfo;
import com.roy.www.alirtc.utils.PermissionUtils;
import com.roy.www.alirtc.utils.SpHistoryUtils;
...
public class VideoCallJoinActivity extends BaseActivity implements View.OnClickListener, TextChangeListener {
    ...
    private void startVideoCallActivity(final String channelId, final String userName) {
        //本地生成token
//        localeBuilderToken(channelId, userName);

        //网络获取token
        getTokenToNetService(channelId, userName);
     ...
     * @param userName
     */
    private void getTokenToNetService(String channelId, String userName) {
     ...
     * @param userName
     */
    private void localeBuilderToken(String channelId, String userName) {
        try {
